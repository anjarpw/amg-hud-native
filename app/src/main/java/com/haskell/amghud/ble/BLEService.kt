    ...
    interface BLEServiceInterface{
        ...
        private val SERVICE_UUID = UUID.fromString("5fafc201-1fb5-459e-8fcc-c5c9c331914C") // Replace with your service UUID
        private val CHARACTERISTIC_UUID = UUID.fromString("ceb5483e-36e1-4688-b7f5-ea07361b26af") // Replace with your characteristic UUID
        private val DESCRIPTOR_UUID = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb") // Standard descriptor UUID
            ...
            override fun onCharacteristicChanged(gatt: BluetoothGatt, characteristic: BluetoothGattCharacteristic) {
                executorService.execute {
                    ...
                    if (data != null && data.isNotEmpty()) {
                        ...
                        sendBroadcast(Intent(BLEConstants.MESSAGE_RECEIVED).putExtra("MESSAGE", message))
                    }
                }
            }
        }
